...
#AI is a parameter(integer) that can be pass externally when running this code.(Eg: AI=1)
AI <- 1
NAI <- as.numeric(AI)
...
v_name <- paste("Results/Example2/Simulation_results/Design_evaluation/","D",d_no,"/out",NAI,".RData",sep="")
