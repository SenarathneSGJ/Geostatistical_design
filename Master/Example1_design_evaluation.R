...
source("Example1/Rcodes/design_selection/combine_ute.R")
source("Example1/Rcodes/design_selection/Exp_crit_all.R")
source("Example1/Rcodes/design_selection/Laplace_approx.R")
source("Example1/Rcodes/design_selection/log_posterior.R")
source("Example1/Rcodes/design_selection/trace_mat.R")
...
for(i in 1:3){
  d.name=paste("Example1/Selected_designs/",Des[i],"_R",Dependence*10,"_D",d_no,".RData",sep="")
  load(d.name)
...
v_name=paste("out",NAI,"R",Dependence*10,"D",d_no,".RData",sep="")
